...
=================================================
CLI entrypoint with render support. Core modules: train_eval, history_reporting, search_driver.
"""
import argparse
import sys
...
from search_driver import (
    SearchDriver, BASELINE_CONFIG, define_search_space, get_mode_presets,
)


# ============================================================================
# Render helpers (will move to main.py in Stage A-7)
# ============================================================================
